 ...
 * forget to set it up.
 * 
 * Run this example with: node examples/test-otel-warning.js
 * (after building the project with yarn build)
 */

const { Gentrace, interaction, traced, experiment, evalOnce } = require('../dist');
...
async function main() {
  ...
  console.log('1. Testing interaction function:');
  console.log('--------------------------------');
