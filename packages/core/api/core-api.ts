...
// @ts-ignore
import { FilesUploadPost201Response } from "../models";
// @ts-ignore
import { FilesUploadPost400Response } from "../models";
// @ts-ignore
...
// @ts-ignore
import { TestResultStatusGet200Response } from "../models";
// @ts-ignore
...
export const CoreApiAxiosParamCreator = function (
  ...
  return {
    ...
    testResultGet: async (
      ...
      assertParamExists("testResultGet", "pipelineSlug", pipelineSlug);
     ...
     * @throws {RequiredError}
     */
    testResultIdGet: async (
      id: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("testResultIdGet", "id", id);
      const localVarPath = `/test-result/{id}`.replace(
        `{${"id"}}`,
     ...
     * @throws {RequiredError}
     */
    testResultStatusGet: async (
      id: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("testResultStatusGet", "id", id);
      const localVarPath = `/test-result/status`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
...
export const CoreApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.testResultIdGet(
        id,
        options,
      );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.testResultStatusGet(id, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
...
export const CoreApiFactory = function (
  ...
  return {
    ...
    testResultStatusGet(
      ...
      return localVarFp
        .testResultStatusGet(id, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class CoreApi extends BaseAPI {
   ...
   * @memberof CoreApi
   */
  public testResultIdGet(id: string, options?: AxiosRequestConfig) {
    return CoreApiFp(this.configuration)
      .testResultIdGet(id, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof CoreApi
   */
  public testResultStatusGet(id: string, options?: AxiosRequestConfig) {
    return CoreApiFp(this.configuration)
      .testResultStatusGet(id, options)
      .then((request) => request(this.axios, this.basePath));
  }
