...
// @ts-ignore
import { TestSetsGet200Response } from '../models';
/**
...
export const CoreApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * 
         * @summary Get test sets, optionally filtered by label
         * @param {string} [label] The label to filter test sets by
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        testSetsGet: async (label?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/test-sets`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const CoreApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async testSetsGet(label?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TestSetsGet200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.testSetsGet(label, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const CoreApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        testSetsGet(label?: string, options?: any): AxiosPromise<TestSetsGet200Response> {
            return localVarFp.testSetsGet(label, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class CoreApi extends BaseAPI {
     ...
     * @memberof CoreApi
     */
    public testSetsGet(label?: string, options?: AxiosRequestConfig) {
        return CoreApiFp(this.configuration).testSetsGet(label, options).then((request) => request(this.axios, this.basePath));
    }
}
