  ...
  return {
    ...
    async testSetsGet(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<TestSetsGet200Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.testSetsGet(
        label,
        options
      );

      const result = createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
        configuration
