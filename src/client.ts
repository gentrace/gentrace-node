...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['GENTRACE_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['GENTRACE_LOG'] or 'warn' if it isn't set.
   */
...
export class Gentrace {
  ...
  constructor({
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('GENTRACE_LOG'), "process.env['GENTRACE_LOG']", this) ??
      defaultLogLevel;
    ...
    const customHeadersEnv = readEnv('GENTRACE_CUSTOM_HEADERS');
    if (customHeadersEnv) {
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://gentrace.ai/api';
  }
  ...
  static Gentrace = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static GentraceError = Errors.GentraceError;
